        ...
        <div class="container">
            ...
            <div class="navbar-collapse collapse justify-content-center" id="navbarDefault">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="propiedad.php">Propiedades</a>
                    </li>
                ...
                <div class="col-sm-12">
                    <div id="property-single-carousel" class="owl-arrow gallery-property">
                        <div class="carousel-item-b">
                            <?php
                            // Obtener la ruta de la imagen desde la base de datos o donde la tengas almacenada
                            $imagen_path = "carpeta_imagenes/" . $propiedades['imagenes'];
                            ?>
                            <img src="<?php echo $imagen_path; ?>" alt="Property Image" style="max-width: 100%; height: auto;">
                        </div>
                    </div>
